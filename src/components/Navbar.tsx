  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed right-4 top-4 z-50 flex h-10 items-center transition-colors sm:right-6 sm:top-5 sm:h-12 lg:right-10 lg:top-5 ${mounted ? "hero-enter" : "hero-enter-start"} ${isLight
      ...
      >
        ...
        <span className={`flex h-full w-10 items-center justify-center transition-colors sm:w-12 ${isLight ? "border-white/40" : "border-border/80"}`}>
          <MenuIcon />
        </span>
      </button>
    </>
